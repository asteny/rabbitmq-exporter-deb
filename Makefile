...
download:
	...
	curl -Lo /tmp/rabbitmq_exporter/rabbitmq_exporter.tar.gz https://github.com/kbudde/rabbitmq_exporter/releases/download/v$(VERSION)/rabbitmq_exporter_$(VERSION)_linux_amd64.tar.gz
